...
describe('ZurichCompartment', function () {
  ...
  it('should set the time constants specified', function () {
    ...
    assert(zurich.n2CoefficientA === 3, 'should set n2CoefficientA')
    assert(zurich.n2CoefficientB === 4, 'should set n2CoefficientB')
    assert(zurich.heCoefficientA === 5, 'should set heCoefficientA')
    assert(zurich.heCoefficientB === 6, 'should set heCoefficientB')
  })
  ...
  it('should return the correct depth values when calling calculateMinimumDepth', function () {
    var zurich = new Zurich()
    zurich.setTimeConstants(1, 2, { a: 5, b: 6 }, { a: 3, b: 4 })
