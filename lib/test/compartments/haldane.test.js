...
describe('HaldaneCompartment', function () {
  ...
  it('should set the time constants specified', function () {
    ...
    assert(haldane.kHe === Math.log(2) / 1, 'should set correct time constant for helium')
    assert(haldane.kN2 === Math.log(2) / 2, 'should set correct time constants for nitrogen')
  })
